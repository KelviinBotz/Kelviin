...
module.exports = zeroyt7 = async (zeroyt7, mek, _welkom) => {
	try {
		...
		let ownerNumber = [`${owner}@s.whatsapp.net`, `6285242935074@s.whatsapp.net`]
...
//━━━━━━━━━━━━━━━[ CONNECTION 1 ]━━━━━━━━━━━━━━━━━//
		...
		mess = {
			...
			success: 'Done Jangan Lupa Subscribe Kelviin001',
			error: {
...
varr =
`Hallo ${pushname} I'M Kelviin have a nice day`
lett =
`𝐁𝐨𝐭 𝐈𝐧𝐟𝐨
Creator : KelviinBot
Prefix : Multi Prefix
...
❋────────────────────────❋
📸 Youtube
https://m.youtube.com/channel/UCel68N4ggELKAO6wZfM-fbQ
📰 Instagram
https://instagram.com/
📺Tiktok
https://www.tiktok.com/@vinnn115
📌 Github
https://github.com/Kelviin
❋────────────────────────❋`           
but = [
...
costum(buffer, sticker, Verived, `Jangan Lupa Subscribe Kelviin001`)
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
buffer = fs.readFileSync(ran)
costum(buffer, image, Verived, `Jangan Lupa Subscribe Kelviin001`)
fs.unlinkSync(ran)
})
break
case 'tomp3':
...
fs.unlinkSync(anum)
buffer = fs.readFileSync(ran)
zeroyt7.sendMessage(from, buffer, video, { quoted: ftrol, caption: 'Done... Jangan Lupa Subscribe Kelviin001' })
fs.unlinkSync(ran)
})
break
...
case 'instagram':
teks =
`Nih Instagram Owner Ku Jangan Lupa Di Follow Ya https://instagram.com/-`
zeroyt7.sendMessage(from, teks, text, {quoted: ftrol})
break
case 'tiktok':
teks =
`Nih Tiktok Owner Ku Jangan Lupa Di Follow Ya https://tiktok.com/@vinnn115`
zeroyt7.sendMessage(from, teks, text, {quoted: ftrol})
break
case 'sourcecode':
case 'script':
...
case 'harrypotter':
if (args.length == 0) return reply(`Teks Nya Mana ?\nContoh: ${prefix + command} Kelviin001`)
zerr = args.join(" ")
buffer = await getBuffer(`https://api.lolhuman.xyz/api/photooxy1/${command}?apikey=${zero}&text=${zerr}`)
zeroyt7.sendMessage(from, buffer, image, {quoted: ftrol, caption: '*©Creator : Kelviin*'})
break
case 'phkomen':
...
zeroyt7.sendMessage(from, gambar, image, { quoted: ftrol, caption: '*©Creator : Kelviin*' })
})
break
...
await zeroyt7.sendMessage(from, get_audio, video, { mimetype: 'video/mp4', filename: `${get_result.title}.mp4`, quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe Kelviin001'})
break
...
reply(mess.wait)
zeroyt7.sendMessage(from, gambar, image, {quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe Kelviin001'})
})
break
case 'darkjoke':
...
zeroyt7.sendMessage(from, buffer, video, {quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe Kelviin001'})
break
case 'asupancecan':
ini = await fetchJson(`https://zeroyt7-api.herokuapp.com/api/asupan/cecan?apikey=${zerkey}`)
reply(mess.wait)
buffer = await getBuffer(ini.result.url)
zeroyt7.sendMessage(from, buffer, image, {quoted: ftrol, caption: 'Nih Jangan Lupa Subscribe Kelviin001'})
break
case 'asupanhijaber':
